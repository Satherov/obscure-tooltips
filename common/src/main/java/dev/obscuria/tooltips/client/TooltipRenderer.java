...
public final class TooltipRenderer {
    ...
    public static boolean render(
        ...
        final var margin = (int) ClientConfig.CONTENT_MARGIN.get();
        ...
        graphics.flush();
        graphics.pose().pushPose();
        graphics.pose().translate(0f, 0f, 5f);
    ...
    private static boolean perform(List<ClientTooltipComponent> components) {
        ...
        if (ItemStack.isSameItemSameComponents(lastStack, actualStack)) return true;
