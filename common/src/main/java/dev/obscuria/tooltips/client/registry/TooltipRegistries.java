...
public interface TooltipRegistries {
    ...
    DelegatedRegistry<Codec<? extends TooltipLayout<?>>> TOOLTIP_LAYOUT_TYPE = REGISTRAR.createRegistry(Key.TOOLTIP_LAYOUT_TYPE);
    ...
    interface Key {
        ...
        ResourceKey<Registry<Codec<? extends TooltipLayout<?>>>> TOOLTIP_LAYOUT_TYPE = create("tooltip_layout_type");
